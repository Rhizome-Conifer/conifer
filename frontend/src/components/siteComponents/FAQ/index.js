    ...
    <div className="container faq">
      ...
      <div className="row heading">
        <aside className="col-sm-3 hidden-xs">
          <img src={require('shared/images/logo.svg')} alt="Conifer logo" />
        </aside>
        <div className="col-xs-10 col-xs-push-1 col-sm-9 col-sm-push-0">
          <h2>Conifer is both a tool to create high-fidelity, interactive captures of any web site you browse and a platform to make those captured websites accessible.</h2>
        </div>
      </div>
      ...
      <div className="row">
        ...
        <div className="col-xs-10 col-xs-push-1 col-sm-9 col-sm-push-0">
          ...
          <h4 className="q">What makes Conifer different?</h4>
          <p className="a">
          ...
          <h4 className="q">How do I use Conifer?</h4>
          <p className="a">
            <a href="https://guide.conifer.rhizome.org/" target="_blank">We created a user guide to help get acquianted.</a>
          </p>

          <h4 className="q">Is Conifer free to use?</h4>
          <p className="a">
            Generally, yes! Conifer offers a limited free tier with 5GB of storage space with some networking quota restrictions. Access to collections that users made public is always free of charge an unlimited.
          </p>
          <p className="a">
          ...
          <h4 className="q">How is Conifer funded?</h4>
          <p className="a">

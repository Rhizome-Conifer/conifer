    ...
    <div className={classNames('conifer-announce', { condensed })}>
      {
        condensed ?
          <div className="announcement">
            <div><b>Twilight announcement</b>: Conifer is going to be discontinued in June 2026. Please read the <a href="https://blog.conifer.rhizome.org/" target="_blank">Conifer blog</a> to learn more.</div>

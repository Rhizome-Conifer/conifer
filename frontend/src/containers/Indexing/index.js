      ...
      <div id="indexingContainer">
        ...
        <div className="progress-window">
          ...
          </div>
          {
            this.state.stalled &&
              <React.Fragment>
                <div className="stalled">Oops, it seems that indexing has stalled. <button className="button-link" type="button" onClick={this.toggleModal}>Addtional info</button></div>
                <Modal

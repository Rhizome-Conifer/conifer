...
let localSettings;
import('./config.local.mjs').then(lc => localSettings = lc)
                        .catch(e => localSettings = {});
...
if (isDesktop) {
  remoteProcess = window.require('electron').remote.process;
...
export default Object.assign({
  ...
  internalApiHost: isDesktop ? remoteProcess.env.INTERNAL_HOST: process.env.INTERNAL_HOST,
  internalApiPort: isDesktop ? remoteProcess.env.INTERNAL_PORT: process.env.INTERNAL_PORT,
